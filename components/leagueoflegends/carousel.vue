      ...
      <div class="absolute w-full bottom-0 left-0 z-10">
        <div class="container mx-auto">
          <div class="relative z-10">
            <div class="text-5xl text-white font-black">Avaible Skins</div>
            <div class="bg-primary w-24 h-2"></div>
          </div>
            ...
            >
              ...
              >
                <div>
                  ...
                  <div
                    class="skin-title text-center text-primary text-3xl font-bold"
                  >
                    <template v-if="slide.name === 'default'">{{
                      $route.params.championId
                    }}</template>
                    <template v-else>{{ slide.name }}</template>
                  </div>
                </div>
              </swiper-slide>
...
.swiper-thumb .swiper-slide .skin-title {
  visibility: hidden;
  opacity: 0;
  transition: opacity 0.2s ease;
}
.swiper-thumb .swiper-slide-active .skin-title {
  visibility: visible;
  opacity: 1;
}
</style>
